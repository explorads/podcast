...
import com.explorads.podcast.net.download.serviceinterface.DownloadServiceInterfaceStub;
...
import com.explorads.podcast.model.feed.FeedComponent;
import com.explorads.podcast.model.feed.FeedItem;
import com.explorads.podcast.model.feed.FeedMedia;
import com.explorads.podcast.core.feed.FeedMother;
import com.explorads.podcast.storage.preferences.UserPreferences.EnqueueLocation;
import com.explorads.podcast.model.playback.Playable;

import static com.explorads.podcast.storage.preferences.UserPreferences.EnqueueLocation.AFTER_CURRENTLY_PLAYING;
import static com.explorads.podcast.storage.preferences.UserPreferences.EnqueueLocation.BACK;
import static com.explorads.podcast.storage.preferences.UserPreferences.EnqueueLocation.FRONT;
import static com.explorads.podcast.core.util.CollectionTestUtil.concat;
import static com.explorads.podcast.core.util.CollectionTestUtil.list;
...
public class ItemEnqueuePositionCalculatorTest {
    ...
    static void doAddToQueueAndAssertResult(String message,
        ...
        Assert.assertEquals(message, idsExpected, FeedItemUtil.getIdList(queue));
    }
