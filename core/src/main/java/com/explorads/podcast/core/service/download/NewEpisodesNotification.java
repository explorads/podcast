...
public class NewEpisodesNotification {
    ...
    private static final String GROUP_KEY = "com.explorads.podcast.EPISODES";
    ...
    private static void showNotification(int newEpisodes, Feed feed, Context context,
        ...
        intent.setComponent(new ComponentName(context, "com.explorads.podcast.activity.MainActivity"));
