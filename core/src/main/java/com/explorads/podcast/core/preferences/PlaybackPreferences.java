package com.explorads.podcast.core.preferences;
...
public class PlaybackPreferences implements SharedPreferences.OnSharedPreferenceChangeListener {
     ...
     * object.
     */
    private static final String PREF_CURRENTLY_PLAYING_FEED_ID = "com.explorads.podcast.preferences.lastPlayedFeedId";
    ...
    private static final String PREF_CURRENTLY_PLAYING_FEEDMEDIA_ID
            = "com.explorads.podcast.preferences.lastPlayedFeedMediaId";
    ...
    private static final String PREF_CURRENTLY_PLAYING_MEDIA_TYPE
            = "com.explorads.podcast.preferences.currentlyPlayingMedia";

    /**
     * True if last played media was a video.
     */
    private static final String PREF_CURRENT_EPISODE_IS_VIDEO = "com.explorads.podcast.preferences.lastIsVideo";

    /**
     * The current player status as int.
     */
    private static final String PREF_CURRENT_PLAYER_STATUS = "com.explorads.podcast.preferences.currentPlayerStatus";
    ...
    private static final String PREF_CURRENTLY_PLAYING_TEMPORARY_PLAYBACK_SPEED
            = "com.explorads.podcast.preferences.temporaryPlaybackSpeed";
