...
public class SynchronizationCredentials {
    ...
    private static final String PREF_USERNAME = "com.explorads.podcast.preferences.gpoddernet.username";
    private static final String PREF_PASSWORD = "com.explorads.podcast.preferences.gpoddernet.password";
    private static final String PREF_DEVICEID = "com.explorads.podcast.preferences.gpoddernet.deviceID";
