...
import com.explorads.podcast.core.service.QuickSettingsTileService;
import com.explorads.podcast.core.storage.DBReader;
import com.explorads.podcast.core.storage.DBWriter;
import com.explorads.podcast.core.storage.FeedSearcher;
...
import com.explorads.podcast.core.widget.WidgetUpdater;
...
import com.explorads.podcast.event.playback.PlaybackServiceEvent;
import com.explorads.podcast.event.playback.SleepTimerUpdatedEvent;
import com.explorads.podcast.event.settings.SkipIntroEndingChangedEvent;
import com.explorads.podcast.event.settings.SpeedPresetChangedEvent;
import com.explorads.podcast.event.settings.VolumeAdaptionChangedEvent;
...
public class PlaybackService extends MediaBrowserServiceCompat {
    ...
    public static final String ACTION_PLAYER_STATUS_CHANGED = "action.com.explorads.podcast.core.service.playerStatusChanged";
     ...
     */
    private static final String CUSTOM_ACTION_SKIP_TO_NEXT = "action.com.explorads.podcast.core.service.skipToNext";
    private static final String CUSTOM_ACTION_FAST_FORWARD = "action.com.explorads.podcast.core.service.fastForward";
    private static final String CUSTOM_ACTION_REWIND = "action.com.explorads.podcast.core.service.rewind";
    private static final String CUSTOM_ACTION_CHANGE_PLAYBACK_SPEED =
            "action.com.explorads.podcast.core.service.changePlaybackSpeed";
